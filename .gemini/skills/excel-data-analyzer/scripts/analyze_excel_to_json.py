...
def analyze_excel_to_json(excel_path, month_str):
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python analyze_excel_to_json.py <excel_file> <target_month>")
        sys.exit(1)
    
    excel_file = sys.argv[1]
    target_month = sys.argv[2]
    
    analyze_excel_to_json(excel_file, target_month)
